...
import com.enterprise.audit.security.JwtAuthFilter;
...
// This class sets up all the security rules for the audit service
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .anyRequest().authenticated()  // all /audit/** endpoints require auth
            )
