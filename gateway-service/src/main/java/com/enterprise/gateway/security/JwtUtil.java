...
// Makes this class a Spring-managed object
@Component
// Reads and checks tokens (the gateway never makes tokens, only reads them)
public class JwtUtil {
    ...
    // Get the team id from a token
    public String extractTeamId(String token) {
        // teamId may not always be present — return null if missing
        return extractClaim(token, c -> c.get("teamId", String.class));
    }
